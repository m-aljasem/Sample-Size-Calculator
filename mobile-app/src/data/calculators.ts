...
export const estimationCalculators: Calculator[] = [
  {
...
export const hypothesisCalculators: Calculator[] = [
  {
    key: 'testProportion',
    title: 'Single Proportion',
    emoji: '🧪',
...
export const ratesCalculators: Calculator[] = [
  {
    key: 'test2Rates',
...
export const defaultInputs: Record<string, Record<string, number>> = {
  ...
  testProportion: { alpha: 0.05, beta: 0.2, p0: 0.5, pa: 0.6, twoTailed: 1, dropoutRate: 0 },
  test2Proportions: { alpha: 0.05, beta: 0.2, p1: 0.6, p2: 0.4, twoTailed: 1, allocationRatio: 1, dropoutRate: 0 },
  test2Means: { alpha: 0.05, beta: 0.2, mu1: 100, mu2: 95, sd1: 15, sd2: 15, twoTailed: 1, allocationRatio: 1, dropoutRate: 0 },
  test2Correlations: { alpha: 0.05, beta: 0.2, r1: 0.5, r2: 0.3, twoTailed: 1, allocationRatio: 1, dropoutRate: 0 },
  test2Rates: { alpha: 0.05, beta: 0.2, lambda1: 0.05, lambda2: 0.03, k: 1, twoTailed: 1, dropoutRate: 0 }
}
